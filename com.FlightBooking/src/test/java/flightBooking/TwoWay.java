...
public class TwoWay extends BaseClass{
	...
	@Test(priority=4,dataProvider="SearchProvider",dataProviderClass=XlsxReader.class)
	public void search(String[] arr) throws InterruptedException
	{
		...
		//driver.findElement(By.xpath(loc.getProperty("firstname2"))).sendKeys(arr[6]);
		//driver.findElement(By.xpath(loc.getProperty("lastname2"))).sendKeys(arr[7]);
